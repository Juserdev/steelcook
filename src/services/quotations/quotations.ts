...
export function content_quotations(TOKEN: string, quoatations: Quotations[], profile: Profile[], quote_settings: Quote_Settings[]): HTMLDivElement {
  const quotation_header = quotation_headers()
  quotation_list(quoatations, quotation_header)
  quotation_form(TOKEN, quotation_header, profile, quote_settings)
