import type { Quotations, Send_Create_Quotation } from "@/app/features/quotations/types/quotations.types";
import { SUPABASE_KEY, SUPABASE_URL } from "../../login/services/auth.services";
