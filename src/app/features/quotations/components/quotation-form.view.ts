...
import { create_btns } from '@/app/features/quotations/components/create-form-btns.view'
import { create_form_fields } from '@/app/features/quotations/components/create-form-fields.view'
import { create_form_section } from '@/app/features/quotations/components/create-form-sections.view'
import { create_form } from '@/app/features/quotations/components/create-form.view'
...
import { create_datalist } from '@/app/features/quotations/utils/create-datalist.utils'
import { fill_form_fileds } from '@/app/features/quotations/utils/fill_form_fileds.utils'
