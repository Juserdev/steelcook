...
import { quotation_btn_add_product } from '@/app/config/quotations/quotation-btn-add-product.config'
import { form_client_aq } from '../../config/quotations/quotation-client.config'
import { form_product_aq } from '../../config/quotations/quotation-product.config'
import { section_types } from '../../config/quotations/quotation-section.config'
import { form_total_aq } from '../../config/quotations/quotation-total.config'
import { form_quote_settings_aq } from '../../config/quotations/quotations-settings.config'
...
import { quotation_btn_submit } from '../../config/quotations/quotation-btn-submit.confing'
import { profile_inputs_map, settings_inputs_map } from '../../config/quotations/quotation-fill-maps.config'
import { form_profile_quotation_aq } from '../../config/quotations/quotation-profile.config'
import { handler_client_autofill } from '../../handlers/quotation/handle-client-autofill'
import { handler_product_add } from '../../handlers/quotation/handle-product-add'
import { handler_product_autofill } from '../../handlers/quotation/handle-product-autofill'
import { handler_product_total } from '../../handlers/quotation/handle-product-total'
import { handler_total_discount } from '../../handlers/quotation/handle-total-discount'
import { handler_total_tax_amount } from '../../handlers/quotation/handle-total-tax-amount'
import { create_datalist } from '../../utils/quotation/create-datalist'
import { fill_form_fileds } from '../../utils/quotation/fill_form_fileds'
import { create_form_section } from '@/app/builders/quotation/create-form-sections'
import { create_form_fields } from '@/app/builders/quotation/create-form-fields'
import { create_form } from '@/app/builders/quotation/create-form'
import { create_btns } from '@/app/builders/quotation/create-form-btns'
